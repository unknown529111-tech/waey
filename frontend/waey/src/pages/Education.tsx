    ...
    <div className="relative min-h-[60vh]">
      ...
      <div className="relative">
        <PageHero
          ...
          title="ذاكر صح، وركّز، وكمّل"
          subtitle="طرق مذاكرة عملية، نصايح للتركيز لو تايه، وكلمتين تحفّز قلبك."
        />
              ...
              <ul className="space-y-3">
                {lostTips.map((t, i) => (
                  <li key={i} className="flex gap-3">
                    ...
                    <span className="leading-relaxed text-sm md:text-base pt-0.5">{t}</span>
                  </li>
                ))}
              </ul>
            </div>
