...
export const EN_QUOTES: string[] = [
  // Health (1-25)
  "Your health is more precious than any wealth.",
  "Prevention is better than cure.",
  "Daily movement is the secret to life.",
  "Good sleep is half of health.",
  "Water is free medicine.",
  "Healthy food is an investment in your future.",
  "Don't postpone your medical checkup.",
  "A sound mind in a sound body.",
  "Cut the sugar and improve your health.",
  "Exercise is a habit, not an occasion.",
  "Balance is the foundation of health.",
  "Rest restores the body's strength.",
  "Smoking steals years from your life.",
  "Smile, for peace of mind is healing.",
  "Eat in moderation to live healthy.",
  "Health starts on your plate.",
  "Don't ignore your body's signals.",
  "Drink water before you feel thirsty.",
  "Health is a blessing beyond price.",
  "Activity boosts productivity.",
  "Mental health matters as much as physical health.",
  "A few minutes of walking beat hours of idleness.",
  "Prevention begins with daily habits.",
  "Every bite shapes your future.",
  "Protect your health before you're forced to seek it.",
  ...
  "A budget is the road to stability.",
  "Steady small amounts beat occasional big ones.",
  "Don't make debt a habit.",
  "Knowledge increases the value of money.",
  "Plan before you buy.",
  "Every pound has value.",
  "Mindful spending saves a lot.",
  "Financial success begins with discipline.",
  "Don't buy what you don't need.",
  "Saving is the habit of the wealthy.",
  "Money needs management, not wishes.",
  "Invest in yourself first.",
  "Don't let emotion drive your financial decisions.",
  "A good income needs good management.",
  "Patience is the key to financial success.",
  "Time creates the value of investment.",
  "Money is a means, not an end.",
  "Learn before you invest.",
  "Don't postpone your financial goals.",
  "Financial success starts with a small step.",
  "Wisdom in spending is richer than a large income.",
  ...
  "A clean environment is health for all.",
  "Reduce waste to protect nature.",
  "Recycling is a civilized habit.",
  "Every drop of water has value.",
  "Keep the air pure.",
  "Nature is a trust in our hands.",
  "Don't throw trash anywhere but its place.",
  "Energy is a shared responsibility.",
  "Plant today to harvest tomorrow.",
  "A healthy environment builds a better society.",
  "Save electricity to preserve resources.",
  "The earth doesn't need us; we need it.",
  "Respecting the environment is respecting life.",
  "Reduce plastic to protect the planet.",
  "Nature rewards those who preserve it.",
  "Start with yourself in protecting the environment.",
  "Every small act makes a big difference.",
  "A tree is a gift to future generations.",
  "Don't pollute what you can't fix.",
  "A clean environment is a duty, not a choice.",
  "Protecting the environment is an investment in the future.",
  ...
  "Experience completes knowledge.",
  "Learning is an investment that never loses.",
  "Knowledge builds nations.",
  "Perseverance is the path to excellence.",
  "Failure is a step toward success.",
  "Learning builds the future.",
  "Curiosity is the key to creativity.",
  "Knowledge grows through action.",
  "The mind grows by reading.",
  "Make learning a daily habit.",
  "Time spent learning is never wasted.",
  "Never stop improving yourself.",
  "The teacher plants and the generations harvest.",
  "Knowledge elevates its owner.",
  "Those who learn today lead tomorrow.",
];
